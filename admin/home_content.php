...
<form method="post" action="home_content_u.php" enctype="multipart/form-data">
	<a href="index.php?url=produk" class="btn btn-info">KEMBALI</a><p/>
	<div class="hidden">
		<label>ID</label>
		<input type="text" name="id" class="form-control" value="<?= $br['id_home'] ?>">
	</div>
	...
	<div class="formm-group">
		<label>Caption</label>
		<input type="text" name="capt" class="form-control" value="<?= $br['caption_home'] ?>">
	</div>
	<div class="formm-group">
		<br>
